...
{{--
    ...
    <nav class="navbar navbar-fixed-top " style="background-color: white">
      <div class="container-fluid">
        <ul class="nav navbar-nav"  style="font-weight:bold;font-size: 20px; width:100%">
          <li class="active"><a href="index.php" style="font-size: 30px;margin-right: 36px;">服飾</a></li>
          <li><a href="index_news.php?op=news_list">SALE</a></li>
          <li><a href="index.php?op=ingredients">MEN</a></li>
          <li><a href="index.php?op=ingredients">WOMEN</a></li>
    ...
    <div class="col-6 col-md-4" style="text-align: center;">
        <div class="thumbnail">
          <div class="box">
            <a href="#"><img  src="{{ asset('/uploads/home/' . $h->image) }}" alt="" class="imageHov"></a>
          </div>
          <div class="caption">
